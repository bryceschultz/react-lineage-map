...
export const graph: GraphProp = {
  nodes: [
    ...
    // Table E
    { id: 'table_E', type: 'table', name: 'Table E' },
    { id: 'table_E:field_E1', type: 'field', name: 'Field E1' },

    // Table F
    { id: 'table_F', type: 'table', name: 'Table F', note: 'This table is created by joining table_D:field_D1 and table_E:field_E1' },
    { id: 'table_F:field_F1', type: 'field', name: 'Field F1' },
  ],
  edges: [
    { source: 'table_A:field_A1', target: 'table_D:field_D1' },
    { source: 'table_B:field_B1', target: 'table_D:field_D1' },
    { source: 'table_C:field_C1', target: 'table_D:field_D4' },
    ...
    { source: 'table_D:field_D1', target: 'table_F:field_F1' },
    { source: 'table_E:field_E1', target: 'table_F:field_F1' },
  ]
}